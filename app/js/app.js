...
pgConfigApp.directive('pgsqlRelated', function() {
  return {
    restrict: 'E',
    templateUrl: '/templates/pgsql-related.html'
  };
});
...
pgConfigApp.directive('serverDetails', function() {
  return {
    restrict: 'E',
    templateUrl: '/templates/server-details.html'
  };
});
...
pgConfigApp.directive('pgbadgerUsage', function() {
  return {
    restrict: 'E',
    templateUrl: '/templates/pgbadger-usage.html'
  };
});
...
pgConfigApp.directive('forkMe', function() {
  return {
    restrict: 'E',
    templateUrl: '/templates/fork-me.html'
  };
});
