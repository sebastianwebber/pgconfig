angular.module('pgconfig.routes', ['ui.router'])
    .config(function ($stateProvider, $urlRouterProvider) {
        $stateProvider
            .state('tuning_url', {
                url: "/tuning?total_ram&max_connections&environment_name&pg_version&os_type&arch&share_link",
                templateUrl: "/app/templates/tuning/main.html"
            })
            .state('tuning-export_url', {
                url: "/tuning/export?total_ram&max_connections&environment_name&pg_version&os_type&arch&share_link",
